 ...
 *
 * <li>If necessary, modify the returned {@link CameraParams.Parameters} object and call
 ...
 *
 * <li>Pass the camera to {@link android.media.MediaRecorder#setCamera(CameraParams)}.
...
public class CameraParams {
     ...
     * {@link CameraParams#setParameters(GreatCamera.Parameters)}. For example, after
     * {@link CameraParams.Parameters#setWhiteBalance} is called, white balance is not
     * actually changed until {@link CameraParams#setParameters(GreatCamera.Parameters)}
     ...
     * should call {@link CameraParams.Parameters#getSupportedColorEffects()} before
     * calling {@link CameraParams.Parameters#setColorEffect(String)}. If the
     * camera does not support color effects,
     * {@link CameraParams.Parameters#getSupportedColorEffects()} will return null.
     */
    public class Parameters {
         ...
         * {@link CameraParams#takePicture takePicture}.</p>
         *
