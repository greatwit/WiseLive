package com.great.happyness.tranfiles.ui.adapter;
...
import com.great.happyness.tranfiles.utils.Constant;
...
public class FileInfoSeletedAdapter extends BaseAdapter {
    ...
    public FileInfoSeletedAdapter(Context mContext) {
        ...
        mDataHashMap = WiseApplication.getAppContext().getFileInfoMap();
...
//                        .into(viewHolder.iv_shortcut);
            ...
            viewHolder.iv_tick.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                	WiseApplication.getAppContext().getFileInfoMap().remove(fileInfo.getFilePath());
