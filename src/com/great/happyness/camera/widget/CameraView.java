...
import com.great.happyness.camera.util.Utils;
...
public class CameraView extends SurfaceView implements
		PreviewCallback, SurfaceHolder.Callback, ICameraOperation,
		IActivityLifiCycle
{
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mVideoEngine = new VideoEngine(context);
        mVideoEngine.initEngine();
        
        Log.i(TAG, "ScreenWidth:"+WiseApplication.SCREEN_WIDTH+ " ScreenHeight:"+WiseApplication.SCREEN_HEIGHT);
    }
    ...
    private void adjustView(Camera.Size adapterSize ){
        int width = WiseApplication.SCREEN_WIDTH;
        ...
        Log.i(TAG, "adjust surfaceView width:"+width + " height:"+height);
