...
import com.great.happyness.camera.PreferenceGroup;
...
import com.great.happyness.camera.ui.CamcorderHeadUpDisplay;
import com.great.happyness.camera.ui.GLRootView;
import com.great.happyness.camera.ui.HeadUpDisplay;
import com.great.happyness.camera.ui.RotateRecordingTime;
...
public class VideoCameraActivity extends NoSearchActivity
    ...
    private void showCameraErrorAndFinish() {
        ...
        Util.showFatalErrorAndFinish(VideoCameraActivity.this,
...
//        mPreviewFrameLayout.setOnSizeChangedListener(this);
        ...
        mOrientationListener = new MyOrientationEventListener(VideoCameraActivity.this);
    ...
    private class MyOrientationEventListener
        ...
        public void onOrientationChanged(int orientation) {
            ...
            int orientationCompensation = mOrientation
                    + Util.getDisplayRotation(VideoCameraActivity.this);
    ...
    public void onInfo(MediaRecorder mr, int what, int extra) {
        if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
            ...
            // Show the toast.
            Toast.makeText(VideoCameraActivity.this, R.string.video_reach_size_limit,
    ...
    private class MyHeadUpDisplayListener implements HeadUpDisplay.Listener {
        public void onSharedPreferencesChanged() {
            mHandler.post(new Runnable() {
                public void run() {
                    VideoCameraActivity.this.onSharedPreferencesChanged();
                }
            });
        }
        ...
        public void onRestorePreferencesClicked() {
            mHandler.post(new Runnable() {
                public void run() {
                    VideoCameraActivity.this.onRestorePreferencesClicked();
                }
            });
        }
